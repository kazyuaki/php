    ...
    <div class="result__content">
        <div class="result-cards">
            ...
            <div class="result-card__body">
                ...
                <p class="result-card__time"><?php echo $tokyo['time']?></pc>
            </div>
            <div class="result-card">
                <div class="result-card__img-wrapper">
                    <img class="result-card__img" src="img/<?php echo $coparison['img']?>" alt="国旗">
                </div>
            </div>
            <div class="result-card__body">
                <p class="result-card__city"><?php echo $comparison['name']?></p>
                <p class="result-card__time"><?php echo $comparison['time']?></pc>
            </div>
        </div> 
    </div>
 </main>
